...
public class StudentIcard extends JFrame{
    ...
    btnUploadSignature.setBackground(new Color(153, 153, 255));
    btnUploadSignature.setBounds(620, 238, 190, 40);
    getContentPane().add(btnUploadSignature);
