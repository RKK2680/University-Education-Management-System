...
public class ViewStudent extends JFrame {
	...
	public ViewStudent() {
		...
		JLabel lblOfflinePaymentDetails = new JLabel("Offline Payment Details");
	...
	public void View_Student() {
	 	   try {
	 			...
	 			String qString="select Roll_No, Name,DO_SO,DOB,Course,Date,Chase,Chase_Amount,DD,DD_Ammunt,Cheque,Cheque_Ammunt,Grand_Total_Amount,Total_Balance_Amount from OfflinePyment";
	 			...
	 			tbl.setColumnIdentifiers(coolName);//Roll_No, Name, DO_SO, Course, DOB, Date, Batch, BookNO, Chase, ChaseDate, Chase_Amount, DD, DD_Date, DD_Ammunt,
	 												//Cheque, Cheque_Date, Cheque_Ammunt, Grand_Total_Amount, Total_Balance_Amount, Rs_in_Worad, Authorety_Sing_Name
	 			String FID,DPN,FN,FDOB,FW,FG,FM,FI,DP,F,DOB,F0,m,F1;
	 			while(rs.next()) {
	 				...
	 				m=rs.getString(13);
	 				F1=rs.getString(14);
	 				String[]rowStrings= {FID,DPN,FN,FDOB,FW,FG,FM,FI,DP,F,DOB,F0,m,F1};
